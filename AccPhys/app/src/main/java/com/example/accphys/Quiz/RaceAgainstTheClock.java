...
public class RaceAgainstTheClock extends AppCompatActivity {

    private TextView timerText, questionText, scoreText, feedbackText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_race_against_the_clock);
        ...
        timeLimit = getIntent().getIntExtra("TIME_LIMIT", 60000*5);
    ...
    private void checkAnswer() {
        ...
        if (selectedAnswer.equals(correctAnswer)) {
            ...
            feedbackText.setText("Incorrect! Correct answer was " + correctAnswer);
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(timeLimit, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(RaceAgainstTheClock.this,
                        "Time's up! Final score: " + score, Toast.LENGTH_LONG).show();
                finish();
            }
        }.start();
    }
